...
function testingPushSearch() {
    ...
    let filteredCoffees2 = []

    coffees.forEach(function(coffees) {
        if (coffees.name.includes(input.value)) {
            filteredCoffees2.push(coffees.name.includes(input.value));
        }
    });
    console.log(tbody.innerHTML = renderCoffees(filteredCoffees2));
}
